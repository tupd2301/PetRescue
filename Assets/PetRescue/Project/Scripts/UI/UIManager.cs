...
public class UIManager : MonoBehaviour
{
    ...
    public IEnumerator ShowWinPopup(float delay = 0)
    {
        ...
        if (_winPopupUI == null)
            _winPopupUI = Instantiate(
                    Resources.Load<WinPopupUI>("Prefabs/UIPrefabs/WinPopup"),
                    canvas.transform
                )
                .GetComponent<WinPopupUI>();
        _winPopupUI.Show();
    }
    ...
    public IEnumerator ShowLosePopup(float delay = 0)
    {
        ...
        if (_losePopupUI == null)
            _losePopupUI = Instantiate(
                    Resources.Load<LosePopupUI>("Prefabs/UIPrefabs/LosePopup"),
                    canvas.transform
                )
                .GetComponent<LosePopupUI>();
        _losePopupUI.Show();
    }
    ...
    public IEnumerator ShowIngameTopContent(float delay = 0)
    {
        ...
        if (_ingameTopContentUI == null)
            _ingameTopContentUI = Instantiate(
                    Resources.Load<IngameTopContentUI>("Prefabs/UIPrefabs/IngameTopContent"),
                    canvas.transform
                )
                .GetComponent<IngameTopContentUI>();
    ...
    public void ShowCloud()
    {
        ...
        {
            _cloudAnimator = Instantiate<GameObject>(
                    Resources.Load<GameObject>("Prefabs/UIPrefabs/Clouds"),
                    canvas.transform
                )
    ...
    {
        if (_settingUI == null)
            _settingUI = Instantiate(
                    Resources.Load<SettingUI>("Prefabs/UIPrefabs/SettingUI"),
                    canvas.transform
                )
                .GetComponent<SettingUI>();
        _settingUI.Show();
    }
}
